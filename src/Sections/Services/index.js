  ...
  return (
    <ServiceSection id="services">
      ...
      <Content ref={addToRefs}>
        <TextBlock
          topic="Design"
          title={<h1>I design scalable backend architecture</h1>}
          subText={
            <h5>
              I help clients, frontend, or employers build the backend of their applications
            </h5>
          }
        />
        <OBJ>
      ...
      <Content ref={addToRefs}>
        <TextBlock
          topic="Develop"
          title={<h1>I Develope high quality and secure Applications</h1>}
          subText={
            <h5>
              I build server-side infrastructures for website & mobile applications with
      ...
      <Content>
        <TextBlock
          topic="Support"
          title={<h1>I provide support for client's digital presence</h1>}
          subText={
            <h5>
