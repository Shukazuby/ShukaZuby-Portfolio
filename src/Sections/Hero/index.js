    ...
    <HomeSection id="home">
      ...
      <MainContent id="home">
        <Lb id="leftBlock">
          <Topic>
            <Circle />
            <span>I Build Secure App</span>
          </Topic>
          <Title>Creating a robust, secure, and high-performing server-side infrastructure.</Title>
          <SubText>
          I work with front-end developers, employers, or clients who require a secured server-side infrastructure foundation on their applications.
          </SubText>
          <CTA>
            Get in touch &nbsp;
